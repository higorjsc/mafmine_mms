...
function Preferencias_shb(geometria, valor_minerio, resultado_rss, resultado_rmr) {
    ...
    let pesos_rss_ob = {
        open_pit:           { muito_fraco: 2.63, fraca: 3.50, moderada: 3.50, forte: 3.50 },
        block_caving:       { muito_fraco: 3.50, fraca: 2.63, moderada: 1.75, forte: 0.00 },
        sublevel_stoping:   { muito_fraco: 0.00, fraca: 0.88, moderada: 3.50, forte: 3.50 },
        sublevel_caving:    { muito_fraco: 0.88, fraca: 2.63, moderada: 2.63, forte: 1.75 },
        longwall:           { muito_fraco: 5.25, fraca: 4.38, moderada: 1.75, forte: 0.88 },
        room_and_pillar:    { muito_fraco: 0.00, fraca: 0.00, moderada: 2.63, forte: 5.25 },
        shrinkage_stoping:  { muito_fraco: 0.00, fraca: 0.88, moderada: 2.63, forte: 3.50 },
        cut_and_fill:       { muito_fraco: 0.00, fraca: 0.88, moderada: 2.63, forte: 2.63 },
        top_slicing:        { muito_fraco: 2.63, fraca: 1.75, moderada: 0.88, forte: 0.00 },
        square_set:         { muito_fraco: 3.50, fraca: 2.63, moderada: 0.88, forte: 0.00 },
    }

    let pesos_rss_hw = {
        open_pit:           { muito_fraco: 2.10, fraca: 2.10, moderada: 2.80, forte: 2.80 },
        block_caving:       { muito_fraco: 2.80, fraca: 2.10, moderada: 1.40, forte: 0.00 },
        sublevel_stoping:   { muito_fraco: 0.00, fraca: 0.70, moderada: 2.80, forte: 3.50 },
        sublevel_caving:    { muito_fraco: 2.80, fraca: 2.10, moderada: 1.40, forte: 0.70 },
        longwall:           { muito_fraco: 4.20, fraca: 3.50, moderada: 2.10, forte: 0.70 },
        room_and_pillar:    { muito_fraco:-7.00, fraca: 0.00, moderada: 1.40, forte: 4.20 },
        shrinkage_stoping:  { muito_fraco: 0.00, fraca: 0.70, moderada: 2.10, forte: 2.80 },
        cut_and_fill:       { muito_fraco: 2.10, fraca: 3.50, moderada: 2.80, forte: 1.40 },
        top_slicing:        { muito_fraco: 2.10, fraca: 1.40, moderada: 1.40, forte: 1.40 },
        square_set:         { muito_fraco: 2.80, fraca: 2.10, moderada: 0.70, forte: 0.00 },
    }

    let pesos_rss_fw = {
        open_pit:           { muito_fraco: 1.32, fraca: 1.32, moderada: 1.76, forte: 1.76 },
        block_caving:       { muito_fraco: 1.76, fraca: 1.32, moderada: 0.88, forte: 0.44 },
        sublevel_stoping:   { muito_fraco: 0.00, fraca: 0.44, moderada: 0.88, forte: 1.32 },
        sublevel_caving:    { muito_fraco: 0.44, fraca: 0.88, moderada: 0.88, forte: 0.88 },
        longwall:           { muito_fraco: 0.00, fraca: 0.44, moderada: 0.88, forte: 0.88 },
        room_and_pillar:    { muito_fraco: 0.00, fraca: 0.00, moderada: 0.44, forte: 1.32 },
        shrinkage_stoping:  { muito_fraco: 0.00, fraca: 0.88, moderada: 1.32, forte: 1.32 },
        cut_and_fill:       { muito_fraco: 0.44, fraca: 1.32, moderada: 0.88, forte: 0.88 },
        top_slicing:        { muito_fraco: 0.88, fraca: 0.88, moderada: 0.44, forte: 0.44 },
        square_set:         { muito_fraco: 1.32, fraca: 0.88, moderada: 0.00, forte: 0.00 }
    }
...
function Preferencias_ubc(geometria, resultado_rss, resultado_rmr) {
    ...
    let pesos_rss_ob = {
        open_pit:           { muito_fraco: 4.00, fraca: 3.00, moderada: 3.00, forte: 3.00 },
        ...
        square_set:         { muito_fraco: 4.00, fraca: 3.00, moderada: 1.00, forte: 0.00 },
    }
    ...
    let pesos_rss_fw = {
        open_pit:           { muito_fraco: 3.00, fraca: 3.00, moderada: 4.00, forte: 4.00 },
        block_caving:       { muito_fraco: 4.00, fraca: 3.00, moderada: 2.00, forte: 1.00 },
        sublevel_stoping:   { muito_fraco: 0.00, fraca: 1.00, moderada: 3.00, forte: 3.00 },
        sublevel_caving:    { muito_fraco: 1.00, fraca: 2.00, moderada: 2.00, forte: 2.00 },
        longwall:           { muito_fraco: 0.00, fraca: 0.00, moderada: 0.00, forte: 0.00 },
        room_and_pillar:    { muito_fraco: 0.00, fraca: 0.00, moderada: 0.00, forte: 0.00 },
        shrinkage_stoping:  { muito_fraco: 0.00, fraca: 2.00, moderada: 3.00, forte: 3.00 },
        cut_and_fill:       { muito_fraco: 1.00, fraca: 3.00, moderada: 2.00, forte: 2.00 },
        top_slicing:        { muito_fraco: 2.00, fraca: 2.00, moderada: 1.00, forte: 1.00 },
        square_set:         { muito_fraco: 3.00, fraca: 2.00, moderada: 0.00, forte: 0.00 },
    }
