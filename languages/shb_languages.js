...
function English() {
    ...
    const paragrafo_explicacao = "The Shahriar and Bakhtavar (Sh&B) mining method selection procedure is a modifiedy version of the UBC (1996) method.<br><br>"
        ...
        + "&ensp;&ensp;-  &ldquo;Ore value &ldquo; was introduced as additional new criteria in the selection process<br>"
        + "&ensp;&ensp;-  &ldquo;Low &ldquo; and  &ldquo;Rarely Steep &ldquo; were included as options in the  &ldquo;Plunge &ldquo; selection criteria<br>"
        + "&ensp;&ensp;-  &ldquo;Rarely Deep &ldquo; was included as an option in the  &ldquo;Depth &ldquo; selection criteria<br><br>"
...
function Portuguese() {
    ...
    let paragrafo_explicacao = "O procedimento de seleção de métodos de lavra de Shahriar e Bakhtavar (Sh&B) é mais uma grande modificação do método UBC (1996).<br><br>"
        ...
        + "&ensp;&ensp;-  &ldquo;Valor do minério &ldquo; foi adicionado como critério de seleção<br>"
        + "&ensp;&ensp;- Adição dos valores  &ldquo;Baixo &ldquo; e  &ldquo;Pouco inclinado &ldquo; como opções para o mergulho do minério<br>"
        + "&ensp;&ensp;- Adição do valor  &ldquo;Pouco profunda &ldquo; como opção para a Profundidade do depósito<br><br>"
        + "<strong>Observações:</strong><br>"
